    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**Users**: {mention}\
                        ...
                        \n**Forward**: True\
                        \n\n**Powered by**: [Abing-Userbot](https://github.com/nabilrmdaan/Abing-Userbot)"
            buttons = [
                (
...
async def infor(event):
    await tgbot.send_message(
        event.chat_id,
        message=f"**Groups**: [sᴜᴘᴘᴏʀᴛ](t.me/AbingSupport)\n**Github**: [Abing-Userbot](https://github.com/nabilrmdaan/Abing-Userbot)\n**Deploy**: [Heroku](https://dashboard.heroku.com/new?template=https://github.com/nabilrmdaan/Abing-Userbot)",
        buttons=[
            [
                custom.Button.inline(
                    "ᴄʟᴏꜱᴇ",
